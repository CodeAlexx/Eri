...
class OmniGenComponent(VisualComponent):
    ...
    output_ports = [
        ...
        create_port("edited_regions", PortType.ANY, PortDirection.OUTPUT, optional=True),
    ...
    property_definitions = [
        ...
        create_property_definition(
            ...
            category="Model",
            metadata={
                "choices": list(OMNIGEN_CONFIGS.keys()),
        ...
        create_property_definition(
            ...
            category="Model",
            metadata={
                "choices": ["auto", "text2img", "editing", "subject_driven", "multi_modal", "instruction"],
                "descriptions": {
        ...
        create_property_definition(
            ...
            category="Generation",
            metadata={
                "choices": ["1:1", "16:9", "9:16", "4:3", "3:4", "2:3", "3:2", "custom"],
        ...
        create_property_definition(
            ...
            metadata={
                "choices": ["single", "multiple", "preserve_identity"],
                "descriptions": {
        ...
        create_property_definition(
            ...
            category="Editing",
            metadata={
                "choices": ["instruction", "mask", "region", "global"],
                "descriptions": {
        ...
        create_property_definition(
            ...
            metadata={
                "choices": ["guided", "blend", "composite", "reference"],
                "descriptions": {
    ...
    def __init__(self, component_id: Optional[str] = None, position=None, scene=None):
        ...
        self.colors = {
            "OmniGen": "#00d4aa",  # Teal green for OmniGen
        }
        self.icons = {
            "OmniGen": "🌐",
        }
